...
if not st.session_state.auth:
    ...
    @keyframes neonBlueGlow {
        0% { text-shadow: 0 0 10px #00c6ff, 0 0 20px #00c6ff, 0 0 40px #0072ff, 0 0 80px #0072ff; }
        50% { text-shadow: 0 0 20px #00eaff, 0 0 40px #00c6ff, 0 0 80px #0072ff, 0 0 120px #0072ff; }
        100% { text-shadow: 0 0 10px #00c6ff, 0 0 20px #00c6ff, 0 0 40px #0072ff, 0 0 80px #0072ff; }
    }
    .david-signature { font-size:6em; font-weight:900; text-align:center; color:#00c6ff; letter-spacing:8px; animation:neonBlueGlow 2s infinite alternate; margin-bottom:0; }
    .subtitle { text-align:center; font-size:1.6em; color:#cceeff; letter-spacing:4px; margin-top:-10px; }
    .stButton>button { width:100%; border-radius:12px; height:3em; font-weight:bold; background: linear-gradient(90deg,#0072ff,#00c6ff); color:white; border:none; transition:0.3s; }
    .stButton>button:hover { transform: scale(1.05); box-shadow: 0 0 25px #00c6ff; }
    .stDownloadButton>button { width:100%; border-radius:12px; height:3em; background: linear-gradient(90deg,#00c6ff,#0072ff); color:white; font-weight:bold; border:none; }
    </style>
